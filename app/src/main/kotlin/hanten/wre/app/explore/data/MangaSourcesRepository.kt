...
import hanten.wre.app.core.model.AnonymousMangaSource
import hanten.wre.app.core.model.MangaSourceInfo
import hanten.wre.app.core.model.getTitle
import hanten.wre.app.core.model.updateMihonTitle
...
import hanten.wre.app.core.util.ext.flattenLatest
		...
		if (locale != null) {
			sources.retainAll { 
				when (it) {
					...
					is hanten.wre.app.mihon.parsers.model.ContentSource -> it.locale == locale
					else -> true
				}
			}
		}
	...
	private fun MangaSourceEntity.toMangaSource(): MangaSource? {
		if (source.startsWith("mihon:") || source.startsWith("MIHON_")) {
			return mihonExtensionManager.getMihonMangaSourceByName(source)
				?: hanten.wre.app.core.model.MangaSource(source, title)
		}
	...
	private fun String.toMangaSourceOrNull(): MangaSource? {
		if (startsWith("mihon:") || startsWith("MIHON_")) {
			return mihonExtensionManager.getMihonMangaSourceByName(this)
				?: hanten.wre.app.core.model.MangaSource(this)
		}
