...
import hanten.wre.app.core.util.ext.toUUIDOrNull
...
class PausingReceiver(
	...
	companion object {
		...
		private const val ACTION_PAUSE = "hanten.wre.app.download.PAUSE"
		private const val ACTION_RESUME = "hanten.wre.app.download.RESUME"
		private const val ACTION_SKIP = "hanten.wre.app.download.SKIP"
		private const val ACTION_SKIP_ALL = "hanten.wre.app.download.SKIP_ALL"
