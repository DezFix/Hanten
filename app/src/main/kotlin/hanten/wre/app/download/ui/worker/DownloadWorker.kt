...
import hanten.wre.app.core.image.BitmapDecoderCompat
...
import hanten.wre.app.core.util.BandwidthLimiter
import hanten.wre.app.core.util.MimeTypes
import hanten.wre.app.core.util.Throttler
import hanten.wre.app.core.util.ext.MimeType
import hanten.wre.app.core.util.ext.awaitFinishedWorkInfosByTag
import hanten.wre.app.core.util.ext.awaitUpdateWork
import hanten.wre.app.core.util.ext.awaitWorkInfosByTag
import hanten.wre.app.core.util.ext.deleteAwait
import hanten.wre.app.core.util.ext.deleteWork
import hanten.wre.app.core.util.ext.deleteWorks
import hanten.wre.app.core.util.ext.ensureSuccess
import hanten.wre.app.core.util.ext.getDisplayMessage
import hanten.wre.app.core.util.ext.getWorkInputData
import hanten.wre.app.core.util.ext.getWorkSpec
import hanten.wre.app.core.util.ext.openSource
...
import hanten.wre.app.core.util.ext.withTicker
import hanten.wre.app.core.util.ext.writeAllCancellable
import hanten.wre.app.core.util.progress.RealtimeEtaEstimator
import hanten.wre.app.download.domain.DownloadProgress
...
import hanten.wre.app.local.domain.MangaLock
...
class DownloadWorker @AssistedInject constructor(
	...
	private val enforceStorageQuotaUseCase: hanten.wre.app.local.domain.EnforceStorageQuotaUseCase,
