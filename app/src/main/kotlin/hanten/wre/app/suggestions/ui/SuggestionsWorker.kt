...
import hanten.wre.app.core.model.distinctById
...
import hanten.wre.app.core.util.ext.asArrayList
import hanten.wre.app.core.util.ext.awaitUniqueWorkInfoByName
import hanten.wre.app.core.util.ext.awaitWorkInfosByTag
import hanten.wre.app.core.util.ext.checkNotificationPermission
import hanten.wre.app.core.util.ext.flatten
...
import hanten.wre.app.core.util.ext.takeMostFrequent
import hanten.wre.app.core.util.ext.toBitmapOrNull
import hanten.wre.app.core.util.ext.trySetForeground
...
import hanten.wre.app.suggestions.domain.MangaSuggestion
...
class SuggestionsWorker @AssistedInject constructor(
	...
	private companion object {
		...
		const val GROUP_SUGGESTION = "hanten.wre.app.SUGGESTIONS"
