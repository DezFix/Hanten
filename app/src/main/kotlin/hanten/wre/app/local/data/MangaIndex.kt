...
import hanten.wre.app.parsers.util.json.getEnumValueOrNull
...
import hanten.wre.app.parsers.util.json.toStringSet
...
class MangaIndex(source: String?) {
	...
	fun sortChaptersByName() {
		...
		val comparator = hanten.wre.app.core.util.AlphanumComparator()
