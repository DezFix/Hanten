...
import hanten.wre.app.alternatives.ui.AlternativesActivity
import hanten.wre.app.backups.ui.backup.BackupDialogFragment
import hanten.wre.app.backups.ui.restore.RestoreDialogFragment
import hanten.wre.app.bookmarks.ui.AllBookmarksActivity
import hanten.wre.app.browser.BrowserActivity
import hanten.wre.app.browser.cloudflare.CloudFlareActivity
import hanten.wre.app.core.exceptions.CloudFlareProtectedException
import hanten.wre.app.core.image.CoilMemoryCacheKey
...
import hanten.wre.app.core.model.isBroken
import hanten.wre.app.core.model.isLocal
import hanten.wre.app.core.model.parcelable.ParcelableManga
import hanten.wre.app.core.model.parcelable.ParcelableMangaListFilter
import hanten.wre.app.core.model.parcelable.ParcelableMangaPage
...
import hanten.wre.app.details.ui.pager.ChaptersPagesSheet
import hanten.wre.app.details.ui.related.RelatedMangaActivity
import hanten.wre.app.details.ui.scrobbling.ScrobblingInfoSheet
import hanten.wre.app.download.ui.dialog.DownloadDialogFragment
import hanten.wre.app.download.ui.list.DownloadsActivity
import hanten.wre.app.favourites.ui.FavouritesActivity
import hanten.wre.app.favourites.ui.categories.FavouriteCategoriesActivity
import hanten.wre.app.favourites.ui.categories.edit.FavouritesCategoryEditActivity
import hanten.wre.app.favourites.ui.categories.select.FavoriteDialog
import hanten.wre.app.filter.ui.FilterCoordinator
import hanten.wre.app.filter.ui.sheet.FilterSheetFragment
import hanten.wre.app.filter.ui.tags.TagsCatalogSheet
import hanten.wre.app.history.ui.HistoryActivity
import hanten.wre.app.image.ui.ImageActivity
import hanten.wre.app.list.ui.config.ListConfigBottomSheet
import hanten.wre.app.list.ui.config.ListConfigSection
import hanten.wre.app.local.ui.ImportDialogFragment
import hanten.wre.app.local.ui.info.LocalInfoDialog
import hanten.wre.app.main.ui.MainActivity
import hanten.wre.app.main.ui.welcome.WelcomeSheet
import hanten.wre.app.reader.ui.colorfilter.ColorFilterConfigActivity
...
import hanten.wre.app.scrobbling.common.ui.config.ScrobblerConfigActivity
import hanten.wre.app.scrobbling.common.ui.selector.ScrobblingSelectorSheet
import hanten.wre.app.search.domain.SearchKind
import hanten.wre.app.search.ui.MangaListActivity
import hanten.wre.app.search.ui.multi.SearchActivity
import hanten.wre.app.settings.SettingsActivity
import hanten.wre.app.settings.override.OverrideConfigActivity
import hanten.wre.app.settings.reader.ReaderTapGridConfigActivity
import hanten.wre.app.settings.sources.TagsBlacklistActivity
import hanten.wre.app.settings.sources.auth.SourceAuthActivity
import hanten.wre.app.settings.sources.catalog.SourcesCatalogActivity
import hanten.wre.app.settings.sources.extension.ExtensionDownloaderActivity
import hanten.wre.app.settings.storage.MangaDirectorySelectDialog
import hanten.wre.app.settings.storage.directories.MangaDirectoriesActivity
import hanten.wre.app.settings.tracker.categories.TrackerCategoriesConfigSheet
import hanten.wre.app.stats.ui.StatsActivity
...
class AppRouter private constructor(
    ...
    fun openDownloadQueue() {
        startActivity(Intent(contextOrNull() ?: return, Class.forName("hanten.wre.app.download.ui.DownloadQueueActivity")))
    }
