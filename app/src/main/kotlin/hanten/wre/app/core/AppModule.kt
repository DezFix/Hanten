...
import hanten.wre.app.backups.domain.BackupObserver
import hanten.wre.app.core.db.MangaDatabase
import hanten.wre.app.core.exceptions.resolve.CaptchaHandler
import hanten.wre.app.core.image.AvifImageDecoder
import hanten.wre.app.core.image.CbzFetcher
import hanten.wre.app.core.image.MangaSourceHeaderInterceptor
import hanten.wre.app.core.network.MangaHttpClient
import hanten.wre.app.core.network.imageproxy.ImageProxyInterceptor
import hanten.wre.app.core.os.AppShortcutManager
import hanten.wre.app.core.os.NetworkState
import hanten.wre.app.core.parser.MangaLoaderContextImpl
import hanten.wre.app.core.parser.favicon.FaviconFetcher
import hanten.wre.app.core.prefs.AppSettings
import hanten.wre.app.core.ui.image.CoilImageGetter
import hanten.wre.app.core.ui.util.ActivityRecreationHandle
import hanten.wre.app.core.util.FileSize
import hanten.wre.app.core.util.ext.connectivityManager
import hanten.wre.app.core.util.ext.isLowRamDevice
import hanten.wre.app.details.ui.pager.pages.MangaPageFetcher
import hanten.wre.app.details.ui.pager.pages.MangaPageKeyer
import hanten.wre.app.local.data.CacheDir
import hanten.wre.app.local.data.FaviconCache
...
import hanten.wre.app.main.domain.CoverRestoreInterceptor
import hanten.wre.app.main.ui.protect.AppProtectHelper
import hanten.wre.app.main.ui.protect.ScreenshotPolicyHelper
import hanten.wre.app.search.ui.MangaSuggestionsProvider
import hanten.wre.app.sync.domain.SyncController
import hanten.wre.app.widget.WidgetUpdater
...
interface AppModule {
	...
	companion object {
		...
		): hanten.wre.app.download.data.dao.DownloadQueueDao = database.getDownloadQueueDao()

		@Provides
		fun provideMangaDao(
			database: MangaDatabase,
		): hanten.wre.app.core.db.dao.MangaDao = database.getMangaDao()
