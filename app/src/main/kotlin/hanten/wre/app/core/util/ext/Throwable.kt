...
import hanten.wre.app.core.exceptions.BadBackupFormatException
import hanten.wre.app.core.exceptions.CaughtException
...
import hanten.wre.app.core.exceptions.EmptyMangaException
import hanten.wre.app.core.exceptions.IncompatiblePluginException
import hanten.wre.app.core.exceptions.InteractiveActionRequiredException
import hanten.wre.app.core.exceptions.NoDataReceivedException
import hanten.wre.app.core.exceptions.NonFileUriException
import hanten.wre.app.core.exceptions.ProxyConfigException
import hanten.wre.app.core.exceptions.SyncApiException
import hanten.wre.app.core.exceptions.UnsupportedFileException
import hanten.wre.app.core.exceptions.UnsupportedSourceException
import hanten.wre.app.core.exceptions.WrapperIOException
import hanten.wre.app.core.exceptions.WrongPasswordException
import hanten.wre.app.core.exceptions.resolve.ExceptionResolver
import hanten.wre.app.parsers.ErrorMessages.FILTER_BOTH_LOCALE_GENRES_NOT_SUPPORTED
import hanten.wre.app.parsers.ErrorMessages.FILTER_BOTH_STATES_GENRES_NOT_SUPPORTED
import hanten.wre.app.parsers.ErrorMessages.FILTER_MULTIPLE_GENRES_NOT_SUPPORTED
import hanten.wre.app.parsers.ErrorMessages.FILTER_MULTIPLE_STATES_NOT_SUPPORTED
import hanten.wre.app.parsers.ErrorMessages.SEARCH_NOT_SUPPORTED
...
fun FileNotFoundException.parseMessage(resources: Resources): String? {
    ...
    /storage/0000-0000/Android/media/d1f08350-0c25-460b-8f50-008e49de3873.jpg.tmp: open failed: EROFS (Read-only file system)
     /storage/emulated/0/Android/data/hanten.wre.app/cache/pages/fe06e192fa371e55918980f7a24c91ea.jpg: open failed: ENOENT (No such file or directory)
     /storage/0000-0000/Android/data/hanten.wre.app/files/manga/e57d3af4-216e-48b2-8432-1541d58eea1e.tmp (I/O error)
     */
    val groups = FNFE_MESSAGE_REGEX.matchEntire(message ?: return null)?.groupValues ?: return null
