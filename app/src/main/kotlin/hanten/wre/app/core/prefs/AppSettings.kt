...
import hanten.wre.app.core.network.DoHProvider
import hanten.wre.app.core.util.ext.connectivityManager
import hanten.wre.app.core.util.ext.getEnumValue
import hanten.wre.app.core.util.ext.observeChanges
import hanten.wre.app.core.util.ext.putAll
...
class AppSettings @Inject constructor(@ApplicationContext context: Context) {
	...
	companion object {
		...
		const val KEY_LINK_WEBSITE = "about_website"
