...
import hanten.wre.app.core.util.ext.getDrawableCompat
import hanten.wre.app.core.util.ext.resolveDp
import hanten.wre.app.core.util.ext.textAndVisible
import hanten.wre.app.databinding.ViewTwoLinesItemBinding
...
class TwoLinesItemView @JvmOverloads constructor(
	...
	init {
		...
		context.withStyledAttributes(
			...
			defStyleRes = R.style.Widget_Hanten_TwoLinesItemView,
		) {
