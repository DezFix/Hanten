...
import hanten.wre.app.mihon.parsers.ContentParser
import hanten.wre.app.mihon.parsers.InternalParsersApi
import hanten.wre.app.mihon.parsers.config.ConfigKey
import hanten.wre.app.mihon.parsers.config.ContentSourceConfig
...
import hanten.wre.app.mihon.parsers.model.Favicons
import hanten.wre.app.mihon.parsers.model.SortOrder
import hanten.wre.app.mihon.parsers.model.search.ContentSearchQuery
import hanten.wre.app.mihon.parsers.model.search.ContentSearchQueryCapabilities
import hanten.wre.app.mihon.parsers.network.OkHttpWebClient
import hanten.wre.app.mihon.parsers.network.WebClient
import hanten.wre.app.mihon.parsers.util.FaviconParser
import hanten.wre.app.mihon.parsers.util.LinkResolver
import hanten.wre.app.mihon.parsers.util.RelatedContentFinder
import hanten.wre.app.mihon.parsers.util.convertToContentListFilter
import hanten.wre.app.mihon.parsers.util.toAbsoluteUrl
import hanten.wre.app.mihon.parsers.util.toContentSearchQueryCapabilities
...
public abstract class AbstractContentParser @InternalParsersApi constructor(
	...
	protected open val userAgentKey: ConfigKey.UserAgent = try {
		...
		ConfigKey.UserAgent(hanten.wre.app.mihon.parsers.network.UserAgents.CHROME_MOBILE)
	}
