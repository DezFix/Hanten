...
import hanten.wre.app.mihon.parsers.util.splitTwoParts
...
fun ContentSource.getOriginLabel(context: Context): String? = when (this) {
	...
	is hanten.wre.app.mihon.model.MihonMangaSource -> "Mihon"
	else -> null
}
...
fun ContentSource.getTitle(context: Context): String {
	val baseTitle = when (val source = unwrap()) {
		...
		is hanten.wre.app.mihon.model.MihonMangaSource -> source.displayName
		else -> {
